...
// メッシュ用 三角形情報  
//==========================================================  
struct KdMeshTriangle  
{  
    DirectX::XMVECTOR p0; // 三角形の頂点1  
    DirectX::XMVECTOR p1; // 三角形の頂点2  
    DirectX::XMVECTOR p2; // 三角形の頂点3  
};  
...
public:
	...
	// 三角形の配列を取得  
	const std::vector<KdMeshTriangle>& GetTriangles() const { return m_triangles; }
...
private:
	...
	// 三角形情報の配列  
	std::vector<KdMeshTriangle> m_triangles;
