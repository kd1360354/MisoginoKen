...
public:
	...
	float GetWheelDelta(std::string_view name) const;
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
// Windowsのマウスホイールを利用した軸制御
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
// マウスホイールの回転量を軸情報（Y軸）として保持する
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
class KdInputAxisForWindowsWheel : public KdInputAxisBase
{
public:
	KdInputAxisForWindowsWheel() {}

	void Update() override;

	// ホイールの回転量 (通常はWM_MOUSEWHEELから取得) を外部からセットする関数
	// ※ この関数をWndProcなど、メッセージ処理部から呼び出す必要があります。
	void SetWheelDelta(int delta) { m_wheelDelta = delta; }

private:
	// 直前のUpdateから蓄積されたホイールの回転量
	int m_wheelDelta = 0;
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
// XInputを利用したゲームパッドのボタン制御
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
// XInputのボタン（WORD）やトリガー（BYTE）の入力を基に状態を更新する
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
class KdInputButtonForGamePad : public KdInputButtonBase
{
public:
	// XInputのボタンフラグ (例: XINPUT_GAMEPAD_A) を指定
	KdInputButtonForGamePad(WORD buttonMask) : m_buttonMask(buttonMask) {}

	// トリガーの場合、閾値と左右を指定 (BYTE: 0～255)
	KdInputButtonForGamePad(BYTE triggerThreshold, bool isLeft);

	// Updateは KdInputCollectorForGamePad から呼ばれるため、オーバーロードで実装
	void Update(const XINPUT_STATE& currentState, const XINPUT_STATE& prevState);

	// KdInputButtonBase の純粋仮想関数を実装（通常は空でOK）
	void Update() override {}
	void GetCode(std::vector<int>& ret) const override {}
...
private:
	...
	BYTE m_triggerThreshold = 0;
	bool m_isLeft = false; // 左トリガーか右トリガーか
};


// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
// XInputを利用したゲームパッドの軸制御
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
// 左/右スティックの移動量（-1.0f～1.0f）を軸情報として保持する
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
class KdInputAxisForGamePad : public KdInputAxisBase
{
public:
	enum class StickType { Left, Right };

	KdInputAxisForGamePad(StickType type);

	// Updateは KdInputCollectorForGamePad から呼ばれるため、オーバーロードで実装
	void Update(const XINPUT_STATE& currentState);

	// KdInputAxisBase の純粋仮想関数を実装（通常は空でOK）
	void Update() override {}
	void PreUpdate() override {}
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
// XInput（ゲームパッド）からの入力をコレクションするクラス
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
// XInputGetStateを使って入力を取得し、ボタン/軸の状態を更新する
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
class KdInputCollectorForGamePad : public KdInputCollector
{
public:
	// コンストラクタでコントローラーのポート番号 (0～3) を指定
	KdInputCollectorForGamePad(int controllerIndex);
	~KdInputCollectorForGamePad() override {}
